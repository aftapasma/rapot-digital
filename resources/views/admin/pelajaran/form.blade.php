        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            <form>
                <div class="grid gap-4 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="last_name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih tingkatan</label>
                        <select id="countries"
            ...
            dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="contoh :A, B, dst" required />
                    </div>
                    <div x-data="{ open: false, search: '', selected: 'Pilih pengajar', options: ['1', '2', '3', '4', '5', '6'] }" class="relative w-full">
                        <label for="class_teacher" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pengajar</label>
                    ...
                    <div>
                        <button type="submit"
                            ...
                            sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Simpan</button>
                    </div>
            </form>
